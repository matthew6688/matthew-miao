...
2. Run the publication validator without `--draft`, then typecheck, unit/localization tests, Cloudflare build, and focused article browser checks.
...
2. Run the validator without `--draft`, typecheck, unit/localization tests, Cloudflare build, and article browser checks.
