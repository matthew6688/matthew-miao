...
| `public/images/products/app-store.svg` | CC0 vector from [SVG Logos](https://github.com/gilbarbara/logos), retained for editorial references; Apple retains trademark rights |
| `public/images/xiaohongshu-wordmark.svg` | Generic platform wordmark component; not linked or shown until Matthew confirms an account |

The article illustration was generated from an abstract tactile-print brief:
scattered manual software tasks flow into a dependable automated system on warm
paper with graphite, muted cobalt, and rust accents. The prompt prohibited text,
people, logos, watermarks, and recognizable product UI.
