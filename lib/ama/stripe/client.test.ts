...
function checkoutInput() {
  return {
    ...
    successUrl: 'https://matthew-miao.com/ama/book/confirmation?hold=claim-1',
    cancelUrl: 'https://matthew-miao.com/ama/book?checkout=cancelled',
...
describe('Stripe Checkout client', () => {
  it('creates a Checkout Session with an idempotency key and form-encoded body', async () => {
    ...
    expect(Object.fromEntries(new URLSearchParams(String(init.body)))).toEqual({
      ...
      success_url: 'https://matthew-miao.com/ama/book/confirmation?hold=claim-1',
      cancel_url: 'https://matthew-miao.com/ama/book?checkout=cancelled',
