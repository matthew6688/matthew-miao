...
const publicPages = [
  ...
  ...localizedPages(
    ...
    {
      zh: '产品 · Matthew Miao。我长期维护的软件产品：从外贸数据、AI 获客到可审核的销售外联工作流。',
      en: 'Products · Matthew Miao. Software products I maintain across trade data, AI-powered growth, and reviewable sales outreach.',
    },
  ),
  ...localizedPages(
    '/ama',
